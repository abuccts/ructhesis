...
这是 \ructhesis{} 的示例文档，基本上覆盖了模板中所有格式的设置。建议大家在使用模
板之前，除了阅读《\ructhesis{}用户手册》，这个示例文档也最好能看一看。
...
\begin{table}[htb]
  ...
  \label{tab:template-files}
    \begin{tabularx}{\linewidth}{lX}
      ...
      ructhesis.ins & \LaTeX{} 安装文件，\textsc{DocStrip}\footnote{表格中的脚注} \\
      ructhesis.dtx & 所有的一切都在这里面\footnote{再来一个}。\\
      ructhesis.cls & 模板类文件。\\
      ructhesis.cfg & 模板配置文。cls 和 cfg 由前两个文件生成。\\
      ructhesis.bst    & 参考文献 BIB\TeX\ 样式文件。\\
      ructhesis.sty   & 常用的包和命令写在这里，减轻主文件的负担。\\
      \bottomrule[1.5pt]
    \end{tabularx}
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
 ...
 \multirow{2}*{\diagbox[width=5em]{x}{y}} & \multicolumn{2}{c|}{First Half} & \multicolumn{2}{c|}{Second Half}\\\cline{2-5}
    ...
    \end{tabularx}\\[2pt]
    \footnotesize 注：数据来源《\ructhesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}[c]{|m{1.5cm}|c|c|c|c|c|c|}\hline
    ...
    \multirow{2}{1.5cm}{Xue} & Rui  & Ni &\multicolumn{4}{c|}{\multirow{2}*{\ructhesis}}\\\cline{2-3}
